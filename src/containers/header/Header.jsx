    ...
    return (
        ...
        <div className='header' id="home">
            ...
            <div className="headlines">
                ...
                <h5>"Welcome to Akash Car Wash Company, your premier destination for top-quality car cleaning services in Amravati. Experience our meticulous attention to detail and commitment to excellence. Let us rejuvenate your vehicle and leave it sparkling clean, inside and out. Trust Akash Car Wash Company for a pristine shine that lasts."</h5>
